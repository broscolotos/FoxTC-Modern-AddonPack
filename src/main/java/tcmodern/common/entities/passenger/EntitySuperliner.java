...
public class EntitySuperliner extends AbstractPassengerCar {

    public EntitySuperliner(World world) {
        super(world);
    ...
    @Override
    public void updateRiderPosition() { TraincraftUtil.updateRider(this, 6.125f, 0.4375f, -0.33f); }
    ...
    public void onRenderInsertRecord() {
        BOBRollingStockModel model = new BOBRollingStockModel(Info.modID, "models/passenger/ModelSuperliner.bob", new boolean[] {false, true, true});
        ...
        Traincraft.traincraftRegistry.RegisterRollingStockModel(new TrainRenderRecord(
                Info.modID, EntitySuperliner.class, model, "Superliner_",
