...
public class EntityHeavyweightTailCar extends EntityRollingStock implements IPassenger {

    public EntityHeavyweightTailCar(World world) {
        super(world);
    }

    public EntityHeavyweightTailCar(World world, double d, double d1, double d2) {
        this(world);
