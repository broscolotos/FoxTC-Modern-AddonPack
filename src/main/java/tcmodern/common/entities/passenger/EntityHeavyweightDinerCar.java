...
public class EntityHeavyweightDinerCar extends EntityRollingStock implements IPassenger {

    public EntityHeavyweightDinerCar(World world) {
        super(world);
    }

    public EntityHeavyweightDinerCar(World world, double d, double d1, double d2) {
        this(world);
